...
namespace favflicks.data.Migrations
{
    ...
    [Migration("20260723121507_UpdateUserProfileStringLength")]
    partial class UpdateUserProfileStringLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("favflicks.data.Models.WatchWith", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("favflicks.data.Models.WatchWith", b =>
                {
                    b.HasOne("favflicks.data.Models.AppUser", "InitiatorUser")
                        .WithMany("InitiatedWatchWiths")
                    ...
                    b.HasOne("favflicks.data.Models.AppUser", "TargetUser")
                        .WithMany("TargetWatchWiths")
            ...
            modelBuilder.Entity("favflicks.data.Models.AppUser", b =>
                {
                    ...
                    b.Navigation("InitiatedWatchWiths");
